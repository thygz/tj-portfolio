                ...
                >
                    ...
                    <div className="flex flex-col min-[550px]:flex-row gap-5 mt-10 lg:mt-7">
                        <Link to="about" smooth={true} duration={700}>
                            <button className="w-full min-[550px]:w-48 py-3 rounded-full bg-[#333333] border border-[#333333] text-[#ffffff] text-base min-[500px]:text-lg lg:text-base font-semibold hover:text-[#333333] hover:border-[#333333] hover:bg-transparent duration-150">
                                Know me better
                            </button>
                        </Link>
                        <Link to="projects" smooth={true} duration={1000}>
                            <button className="w-full min-[550px]:w-48 py-3 rounded-full border border-[#333333] text-[#333333] text-base min-[500px]:text-lg lg:text-base font-semibold hover:bg-[#333333] hover:text-[#ffffff] hover:border-[#333333] duration-150">
                                Look what I can do
                            </button>
                        </Link>
                    </div>
